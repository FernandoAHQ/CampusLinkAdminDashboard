...
type props = {openEditModal: boolean, setOpenEditModal: Function, studentData: StudentDataType, setStudentData:Function, updateStudent: Function}

function EditStudentModal({openEditModal, setOpenEditModal, studentData, setStudentData, updateStudent}: props) {
